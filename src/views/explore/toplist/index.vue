  ...
  <div>
    ...
    <div id="main">
      ...
      <ul class="topnews">
        <v-touch
          tag="li"
          @tap="handleTo(item.id)"
          class="_link"
          v-for="(item, index) in toplistNews"
          :key="index"
          :id="item.id"
        >
...
export default {
  ...
  async created() {
    ...
    this.getBanner = response2.topList;
  },
  data() {
    return {
      toplistNews: [],
...
.newslist .topmenu .top01 {
  background: url(//static1.mtime.cn/html5/20190531185056/images/2014/top01.png)
    no-repeat;
...
.newslist .topmenu .top02 {
  background: url(//static1.mtime.cn/html5/20190531185056/images/2014/top02.png)
    no-repeat;
  background-size: cover;
}
...
.newslist .topmenu .top03 {
  background: url(//static1.mtime.cn/html5/20190531185056/images/2014/top03.png)
    no-repeat;
  background-size: cover;
}
